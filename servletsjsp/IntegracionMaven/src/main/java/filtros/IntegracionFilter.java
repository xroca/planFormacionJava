 ...
 * @author Chema
 */
public class IntegracionFilter implements Filter {
    ...
    public IntegracionFilter() {
    }

    private void doBeforeProcessing(RequestWrapper request, ResponseWrapper response)
            throws IOException, ServletException {
        if (debug) {
            log("IntegracionFilter:DoBeforeProcessing");
        }
        EntityManagerFactory emf = (EntityManagerFactory) request.getSession(true).getServletContext().getAttribute("emf");
        request.setAttribute("em", emf.createEntityManager());
    }

    private void doAfterProcessing(RequestWrapper request, ResponseWrapper response)
            throws IOException, ServletException {
        if (debug) {
            log("IntegracionFilter:DoAfterProcessing");
        }
    ...
    public void doFilter(ServletRequest request, ServletResponse response,
        ...
        if (debug) {
            log("IntegracionFilter:doFilter()");
        }
    ...
    public void init(FilterConfig filterConfig) {
        ...
        if (filterConfig != null) {
            if (debug) {
                log("IntegracionFilter: Initializing filter");
            }
        }
    }
    ...
    public String toString() {
        ...
        if (filterConfig == null) {
            return ("IntegracionFilter()");
        }
        StringBuilder sb = new StringBuilder("IntegracionFilter(");
    ...
    class RequestWrapper extends HttpServletRequestWrapper {
        ...
        public void setParameter(String name, String[] values) {
            if (debug) {
                System.out.println("IntegracionFilter::setParameter(" + name + "=" + values + ")" + " localParams = " + localParams);
            }
        ...
        public String getParameter(String name) {
            if (debug) {
                System.out.println("IntegracionFilter::getParameter(" + name + ") localParams = " + localParams);
            }
            if (localParams == null) {
        ...
        public String[] getParameterValues(String name) {
            if (debug) {
                System.out.println("IntegracionFilter::getParameterValues(" + name + ") localParams = " + localParams);
            }
            if (localParams == null) {
        ...
        public Enumeration getParameterNames() {
            if (debug) {
                System.out.println("IntegracionFilter::getParameterNames() localParams = " + localParams);
            }
            if (localParams == null) {
        ...
        public Map getParameterMap() {
            if (debug) {
                System.out.println("IntegracionFilter::getParameterMap() localParams = " + localParams);
            }
            if (localParams == null) {

...
public class UsuarioDaoTest {
    ...
    public void testActualizar() {
        ...
        Usuario u = instance.encontrar(nuevo);
        u.setNombre("xyz");
        nuevo = instance.actualizar(u);
        u = instance.encontrar(nuevo);
...
//     */
    ...
    public void testTodos() {        
        ...
        List<Usuario> guardados = usuarios.parallelStream().map(instance::guardar).collect(Collectors.toList());
